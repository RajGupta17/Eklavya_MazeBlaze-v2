...
esp_err_t enable_lsa()
{
    ...
    flag_8 = adc2_config_channel_atten(ADC2_CHANNEL_0, ADC_ATTEN_DB_11);
    return flag_0 || flag_1 || flag_2 || flag_3 || flag_4 || flag_5 || flag_6 || flag_7 || flag_8; // we use or || because success of flag is 0 here
}

int get_reading_lsa() // gets raw readings in range of 400 - 2000 appx
{
    ...
    lsa_reading[6] = adc1_get_raw(ADC2_CHANNEL_0);
